...
- Project Phase 3 issue #13 remains on `codex/phase3-resident-provider` with draft PR #15. The closeout continuation starts from exact project head `4410a7c92cc9e2678dbf8651c2f44658e875c5f3` and optimized nested head `a120de8e2d0b552c51eacd7d701ef1dd994bc3db`. The immutable standing evidence commit is `93635d7ece8fdc617291d5a036bda1c8bc2b6c77`; its capture SHA-256 is `23eff115b87a9e8cee101bd1c0b02f299786175e786b4b30dd4a7e66617d4970`. The raw gate remains failed at 22/24 cells. Design-authority comments `5128658370` and `5128726338` accept the Phase 3 technical exit as `PASS_WITH_NOTES` for progression only. No further Phase 3 measurement or optimization is authorized. The exact Checkpoint B candidate is being prepared; Checkpoint B, final review, repository-owner merge authorization, and merge remain pending.
...
Complete the bounded structured Phase 3 disposition, publish its exact project-only commit, and request fresh independent Checkpoint B review. Do not run another Phase 3 measurement, start cache implementation, merge PR #15, close issue #13, or create an upstream `llama.cpp` PR.
