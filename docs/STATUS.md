...
- Project Phase 3 issue #13 remains on `codex/phase3-resident-provider` with draft PR #15. Design-authority comment `5127774849` approved a bounded corrective amendment from project head `bb9a7778b207c248646c46083c03bdef5076c5bf` and nested head `523f825d2df5efa7c9a08561e2b64861ad5594c5`. The published resident-provider administrative fast path is nested commit `a120de8e2d0b552c51eacd7d701ef1dd994bc3db`; capture tooling is at project commit `b93bbe070c7039edfb1a154cd2fe0b292b0d79d4`; and all prerequisite evidence passes at published project commit `3532655f9c11bac214269d5ab75f8dabf0f3c004`. The one authorized post-optimization v2 capture completed once at project prerequisite head `c6f41a6fa49a1f245dd4e6c8e902fc5ca543cfdb`; its standing evidence is published at `93635d7ece8fdc617291d5a036bda1c8bc2b6c77`. It failed 2 of 24 performance cells: MXFP4 CUDA disabled-versus-resident prompt throughput and TTFT. Its result stands. The previous standing capture and two corrected failed attempts remain immutable, non-authoritative history. Phase 3 returns to `design-required` and is not eligible for Checkpoint B, final review, or merge.
...
Return issue #13 to design authority with the complete corrective and v2 evidence. Do not run another capture, pool or compose attempts, request Checkpoint B, merge PR #15, or create an upstream `llama.cpp` PR. A future implementation or validation attempt requires a new approved issue amendment and restart contract.
