...
The first prospectively approved standing capture completed at `2026-07-30T06:53:38.449543+00:00` and failed 3 of 24 gated metric cells. It and the two earlier corrected attempts remain immutable historical evidence; their samples cannot be selected, pooled, overwritten, or composed into the corrective disposition. Design-authority comment `5127774849` preserves the exact workload, process order, statistics, and original budgets while authorizing one complete post-optimization v2 capture after all corrective prerequisites pass. That capture has not started at this handoff. These are control-derived noise gates for the tiny fixtures, not production regression tolerances.
