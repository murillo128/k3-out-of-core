...
The prospectively approved standing final capture completed at `2026-07-30T06:53:38.449543+00:00`; its result is final without retry or cross-attempt selection. Twenty-one of 24 gated metric cells pass. F16 CPU disabled-versus-resident prompt throughput has a 5.019635% upper bound and TTFT has a 5.630880% upper bound, both above the 3.485397% budget. MXFP4 CUDA disabled-versus-resident TTFT has a 2.411496% upper bound, narrowly above its 2.400604% budget. All baseline-versus-disabled comparisons pass, as do the remaining resident comparisons. The Phase 3 performance exit gate is therefore `BLOCKED` pending a design-authority decision; no additional capture is authorized. Earlier corrected attempts remain historical failed evidence, and their rejected composed report is not used. These are control-derived noise gates for the tiny fixtures, not production regression tolerances.
