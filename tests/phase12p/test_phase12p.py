...
from verify_evidence import verify as verify_evidence  # noqa: E402
...
class Phase12PTests(unittest.TestCase):
    ...
    def test_committed_blocked_evidence_when_present(self) -> None:
        results = ROOT / "results/2026-08-05/msi-edgexpert-gb10/phase12p"
        if results.exists():
            verify_evidence(results)
