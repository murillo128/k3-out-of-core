...
- Corrected A/B speedup: `0.497963x` (95% paired bootstrap `0.495169`–`0.501099`).
- Capacity-matched B-prime speedup: `0.376192x`.
...
- LRU feasibility scan: `0.010006%` of B decode wall, below the 3% index threshold.
- Windowed trace: seed 61, request 15, layer 11, 1000 ms; A/B traces are 1068131 and 398391 bytes.
