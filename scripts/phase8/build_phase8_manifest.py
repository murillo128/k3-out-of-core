...
from common import (CHECKPOINT_A_COMMENT, CHECKPOINT_B_COMMENT, LLAMA_BASE,
                    LLAMA_CHECKPOINT_B, PHASE7_FINAL_REVIEW_COMMENT, PHASE7_MANIFEST,
                    PHASE8_START, PROJECT_BASE, environment, git, identity, write)
...
def main() -> int:
    ...
    manifest = {
        ...
        "revisions": {"branch": "codex/phase8-miss-execution", "project_execution_base": PROJECT_BASE,
                      ...
                      "llama_cpp_base": LLAMA_BASE, "llama_cpp_final": LLAMA_CHECKPOINT_B,
        ...
        "checkpoint_b": {"comment_id": CHECKPOINT_B_COMMENT, "verdict": "PASS", "safety_to_proceed": "YES",
                         "project_head": PHASE8_START, "llama_cpp_head": LLAMA_CHECKPOINT_B, "independent_read_only": True},
        "final_review": None,
        "inputs": {"phase7_manifest": identity(root, phase7),
                   ...
                   "larger_public_moe": {"repository": "ibm-granite/granite-3.1-3b-a800m-instruct",
                       "source_revision": args.public_source_revision,
                       "primary_failure_comment": 5145455677,
                       ...
                       "converter_head": LLAMA_CHECKPOINT_B, "conversion_command": args.public_conversion_command},
        ...
        "gates": {"original_split_k3_numerical": True, "larger_public_moe": True,
                  ...
                  "checkpoint_b_accepted": True, "scope_lineage_and_whitespace": True},
        "carried_notes": [
