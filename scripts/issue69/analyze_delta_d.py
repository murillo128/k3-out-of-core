...
def workload_summary(path: Path) -> dict[str, object]:
    ...
    return {
        ...
        "io_access_requested": workload.get("io_access_requested", workload.get("io_access")),
        "io_access_effective": workload.get("io_access_effective", workload.get("io_access")),
